...
class ListFilterComicView extends GetView {
  const ListFilterComicView(
...
class ListFilterComic extends GetView<DashboardController> {
  @override
  Widget build(BuildContext context) {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () async {
        ...
        await controller.fetchFilteredComics();
